...
const svg = (path, width = 64, height = 64) =>
  `<svg viewBox="0 0 ${width} ${height}"><path d="${path}"/></svg>`;
...
const ease = [quadOut, quartIn, quintOut];
...
const transform = (target, data) => {
  const { x = 0, y = 0, rotation = 0, opacity = 1 } = data;
...
const uiIcons = {
  gold: svg(
    "M31 3c-1 0-3 0-4 2l-1 1-1-1-5-1c-2 0-3 1-4 3l-1 1h-1l-4-1-2 2 10 8h7l6-3 4-10a5 6 0 00-4-1zm2 12a17 17 0 01-10 5l-2 2h1c0 3 1 6 3 8l-2 1-3-4 2 9-2 1c-2-6-3-12 0-17l-3-1-1 2c-4 5-6 11-5 15 0 3 2 5 3 7a19 19 0 016 1h3l10 2 2 1a4 5 0 010-1l-1-4c0-2 1-4 3-5v-2l-2-4 1-2a5 5 0 01-1-5l-2-3 2-4-2-2zm14 1l-8 1c-2 1-3 2-3 4l3 3 8 2 4-1v-2l4-1v2l3-3c0-2-1-3-3-4l-8-1zm12 8l-2 1 1 4 2-3-1-2zm-22 2l3 3 9 2 5-1v-3l-7 1-9-2zm1 4l-1 1 3 4 9 1h4v-3a25 25 0 01-14-2zm22 0a11 11 0 01-3 2v2l3-3zm1 5l-1 1v4l2-3-1-2zm-22 2l3 3a22 22 0 0014 1v-3l-7 1-10-2zm-1 2c-2 1-2 2-2 3l3 3 8 2h4v-3h-1c-3 0-6 0-9-2-1 0-3-1-3-3zm20 4l-3 1v1c2 0 2-1 3-2zm1 2l-2 2v3l3-3-1-2zm-43 1a19 19 0 00-11 3c-2 2-3 3-2 4 0 1 1 2 3 2h7l3-1v-2l4-3v3l2-4-3-2h-3zm7 0l1 2v2a14 14 0 015 3l3-2v3l3-3-3-3-9-2zm14 1l3 4 9 1h4v-4a24 24 0 01-16-1zm1 5l-1 1 3 3 9 2 4-1v-3a25 25 0 01-14-1zm21 0a11 12 0 01-2 1v3l3-3zm-36 0l-2 2a22 22 0 01-11 4l2 2 7 2 4-1v-2l4-2v3l2-3-3-3-3-2z",
  ),
  book: svg(
    "M7 5v31l10 4v-3l-8-4 2-1 6 2-3-27-7-2zm50 0c-8 3-18 0-24 9v26c2-3 6-5 9-5 4-1 8-1 11-4l2 2c-4 3-9 3-13 4-3 1-7 2-9 8l24-9zM16 6l3 29v27l3-5 3 5V37L21 7zm8 3l3 27a11 11 0 014 4V14l-7-5zM3 9v31l14 5v-3L5 38V9zm56 0v29L32 48l-5-2v5c3 1 7 0 11-1v-2l23-8V9zM27 39v4l3 2-3-6z",
  ),
  level: svg(
    "M12 2v19l1 1 15 3 6-8 6 8a68 62 0 0016-4l1-19-11 12-5-12-7 13-7-13-5 12zm22 19l-4 5 4 5 4-5zm-23 3h-1c0 1 0 2 3 3l17 3-2-3a57 51 0 01-17-3zm46 0h-1l-15 3-3 3c6 0 11-1 17-3l3-3h-1zm-3 5l-17 4-3 2-2-2-18-3c-2 3-3 7-3 11 5 2 9 5 11 8 1 3 2 7 1 10l3 1 1-6h3l-1 7h4v-7h3v7h4l-1-7h2l1 6 3-2c0-3 0-6 2-9s5-5 10-8l-3-12zm-36 6c4 0 9 2 14 5-7 4-18 4-15-5zm33 0h1c3 9-8 9-15 5 5-3 9-5 14-5zm-17 7l4 8h-7c0-3 2-6 3-8z",
  ),
  battle: svg(
    "M8 2a2 2 0 00-1 1 2 2 0 002 4l7 8-6 5 3 4 4-7 1 5 10-2-3-3-5-2 7-4-3-3-6 5-8-8a2 2 0 00-2-3zm48 0a2 2 0 00-2 3l-7 8-6-5-3 3 7 4-5 2-3 3 10 1v-4l5 7 3-4-6-5 7-8a2 2 0 100-5zM33 22l-15 2c0 11 4 26 15 33 10-7 15-22 15-33l-15-2zM18 41L8 53l-2 8 8-2 8-10-4-8zm29 1l-4 8 8 9 8 2-2-8z",
  ),
  morality: svg(
    "M32 3a29 29 0 100 58 29 29 0 000-58zm-1 2c-15 1-15 27 1 27s16 26 1 27h-1a27 27 0 01-1-54zm1 8c3 0 5 2 5 5s-2 5-5 5-5-2-5-5 2-5 5-5zm0 28c-3 0-5 2-5 5s2 5 5 5 5-2 5-5-2-5-5-5z",
  ),
  trophy: svg(
    "M32 3L17 4l-4 1h-2l-1 2v4H7V8L4 7C3 20 8 33 18 42l1-3-1-2 2-2 6 4c3 2 1 4-3 5 7 1 5 7-2 11h-1l-3 1-2 1v2l2 1 3 1a86 86 0 0027-1l1-1 1-1-1-1-1-1-3-1h-1c-7-4-9-10-2-11-4-1-6-3-3-5l6-4 2 2-2 2 2 3c10-9 15-22 14-35l-3 1v3h-3V7l-1-2h-2l-4-1-15-1zm0 2a99 99 0 0118 2h1-1a98 98 0 01-36 0h-1 1a98 98 0 0118-2zM7 14h4c1 7 3 14 7 18l-3 3c-4-6-7-14-8-21zm46 0h4c-1 7-4 14-9 20l-2-2c4-4 6-11 7-18z",
  ),
};
...
const units = [
  [
    svg(
      "M64 4C34 4 4 19 4 42c0 15 11 22 11 37 0 11-4 11-4 19 0 4 12 8 23 11v15h60v-15s23-7 22-11c0-7-3-8-3-19 0-7 11-23 11-37 0-23-30-38-60-38zM41 49a15 15 0 110 30 15 15 0 010-30zm45 0a15 15 0 110 30 15 15 0 010-30zM64 75c4 0 11 15 11 19 0 8 0 8-4 8H56c-3 0-3 0-3-8 0-4 7-19 11-19z",
      128,
      128,
    ),
    "💀",
  ...
  [
    svg(
      "M31 3c-8 0-16 2-21 5H9c3 7 6 12 10 16v9l8 4-6 24h24l-4-17 8 13 2-1c-2-6-6-10-9-14l4-3-6-13 6-5c-2-4-5-8-9-11-4 2-6 7-9 11l-4 5-9-12c9-6 24-8 37-5-5-5-13-6-21-6z",
    ),
    "👽",
    20400, // 1200 * 17
    16,
...
const formatNumber = (number, floor = true) => {
  ...
  if (floor) {
    return (
      ...
      (
        m.floor(
          (number / m.pow(10, m.floor(m.abs(m.log10(number)) / 3) * 3)) * 10,
        ) / 10
      ).toFixed(1) +
      getAbbreviatedNumberNotation(m.floor(m.log10(number)))
    );
  }
  return (
    sign +
...
const restartGame = () => {
  ...
  if (
    !confirm(
      "This will make things easier as you keep your attributes and trophy bonuses.",
    )
  ) {
    return;
  }
...
const renderPlayerGoldPerSecond = () => {
  playerGoldPerSecondElement.innerHTML = `+${formatNumber(
    m.pow(gameState[22], gameState[9]) *
      10 *
      getSkillBonus(null, skillKey.prosperity, true),
  )}/s`;
};

const skillAtLevelCost = (skillToUpgrade, level) =>
  m.ceil(skillToUpgrade[4] * m.pow(skillToUpgrade[5], level));
...
const getUnusedAttributes = () =>
  gameState[4] - 1 - gameState[6] - gameState[7];

const getUnusedSkills = () =>
  m.min(6, m.floor(gameState[4] / 6)) - getLength(gameState[15]);
  ...
  for (let i = 0; i < getLength(elements); i++) {
    if (gameState[34]) {
      ...
      insertHtml(
        ...
        afterbegin,
        svg(
          "M32 2c-10 0-18 8-18 19v9h6v-9a12 12 0 1124 0v9h6v-9c0-10-8-19-18-19zM11 32l-3 9c0 12 10 21 24 21 13 0 24-9 24-21l-3-9zm21 3c3 0 5 2 5 5 0 2-1 4-3 5l4 12H26l4-12a5 5 0 012-10z",
        ),
      );
    }
  }
...
const renderPlayerSkills = () => {
  ...
  if (skillPointsAvailable > 0) {
    ...
    for (let i = 0; i < getLength(gameState[15]); i++) {
      ...
      skillHtml += `<a href="#" title="${
        skills[gameState[15][i]][1]
      }" class="${skillUpgradeClass}" data-id="${i}"><div><span class="skillStats"><span class="skillLevelInfo">lvl ${
        gameState[16][i]
      } / </span>+${getSkillBonus(i)}%</span><span>${
        skills[gameState[15][i]][0]
      }</span></div><div class="cost"><span>${formatNumber(
        nextLevelCost[0],
      )}</span><span class="buy">Buy</span></div></a>`;
    }
    if (getLength(gameState[15]) < 6) {
      skillHtml += `<a href="#" class="nextSkill"><span>lvl ${m.round(
        (getLength(gameState[15]) + 1) * 6,
      )}</span></a>`;
    }
  }
...
const addPlayerGold = (amount) => {
  const amountGained =
    amount * gameState[35] * getSkillBonus(null, skillKey.prosperity, true);
...
const expNeededForNextLevel = (level) =>
  expNeededForLevel(level + 1) - expNeededForLevel(level);
...
const renderPlayerNextLevelProgress = () => {
  playerNextLevelProgressElement.innerHTML = `${m.round(
    ((expNeededForNextLevel(gameState[4]) -
      (expNeededForNextLevel(gameState[4]) -
        (gameState[5] - expNeededForLevel(gameState[4])))) /
      expNeededForNextLevel(gameState[4])) *
      100,
  )}%`;
};
...
const renderTrophies = () => {
  ...
  for (let i = 0; i < getLength(trophies); i++) {
    ...
    title = trophyChecks[trophies[i].type].title.replace(
      "XXX",
      formatNumber(trophies[i].value),
    );
    ...
    const trophyColor =
      trophyColors[unlockedTrophiesInCategory[trophies[i].type]];
    ...
    if (trophyClass == 'class="openPopUp"') {
      if (gameState[34]) {
        ...
        trophyListElement.innerHTML += `<li ${trophyClass} title="${title}">${icon.replace(
          "<path ",
          '<path fill="#444" ',
        )}</li>`;
      }
  ...
  trophyTitleElement.innerHTML = `Trophies - ${getLength(
    gameState[23],
  )}/${getLength(trophies)}`;
  ...
  getElemById("trophyBonusAmount").innerText = `${m.round(
    (gameState[35] - 1) * 100,
  )}%`;
...
const getEnemyLevels = (stage) => {
  ...
  for (let i = 0; i < getLength(units); i++) {
    ...
    enemyUnits.push(
      m.floor(m.sqrt(m.pow(1.25, 5 + stage - unitUnlockLevel[i] / 2))),
    );
  }
...
const renderEnemyUnits = () => {
  ...
  for (let i = 0; i < getLength(enemyLevels); i++) {
    ...
    enemyHTML += `<span id="e-${i}-amount">${formatNumber(
      gameState[10][i],
      true,
    )}</span>`;
    if (gameState[34]) {
...
const renderUnitGenerationProgress = () => {
  ...
  playerUnitTimeProgressElements[gameState[17]].innerHTML = `${m.floor(
    m.max(
      0,
      m.min(
        100,
        (gameState[14][gameState[17]] /
          (units[gameState[17]][2] *
            m.max(0.1, 1 - getSkillBonus(null, skillKey.necromancy) * 0.01))) *
          100,
      ),
    ),
  )}%`;
...
const renderPlayerUnit = (unit) => {
  ...
  playerUnitAmountElements[unit].innerHTML = formatNumber(
    gameState[12][unit],
    true,
  );
};
...
const renderPlayerUnits = () => {
  ...
  for (let i = 0; i < getLength(gameState[12]); i++) {
    ...
    playerHTML += `<span class="p-amount" id="p-${i}-amount">${formatNumber(
      gameState[12][i],
      true,
    )}</span>`;
  ...
  if (getLength(gameState[12]) < getLength(units)) {
    playerHTML += `<div class="unit not"><div id="next-unit-lock" class="c"></div>${
      units[getLength(gameState[12])][0]
    }<span class="p-amount">#${
      unitUnlockLevel[getLength(gameState[12])] + 2
    }</span></div>`;
  }
  ...
  playerUnitTimeProgressElements =
    player.getElementsByClassName("unit-progress");
...
const addPlayerUnitGenerationProgress = (progress) => {
  ...
  const timeToGenerateOneUnit =
    units[gameState[17]][2] *
    m.max(0.1, 1 - getSkillBonus(null, skillKey.necromancy) * 0.01);
  if (gameState[14][gameState[17]] > timeToGenerateOneUnit) {
    const unitsGenerated = m.floor(
      gameState[14][gameState[17]] / timeToGenerateOneUnit,
    );
...
const calculateAttackDamage = (
  ...
  if (isPlayerAttacking) {
    ...
    attackDefenseDifference =
      gameState[36] +
      gameState[6] +
      units[attackerUnit][3] -
      units[defenderUnit][4] -
      10;
  } else {
  ...
  if (attackDefenseDifference > 0) {
    if (isPlayerAttacking) {
      damage *=
        (1 + attackDefenseDifference * 0.05) *
        getSkillBonus(null, skillKey.wrath, true);
    } else {
    ...
    if (isPlayerAttacking) {
      ...
      damage *= m.max(
        ...
        1 +
          attackDefenseDifference *
            0.025 *
            getSkillBonus(null, skillKey.calm, true),
      );
    }
  }
...
let doAnAttack = () => {
  ...
  tween(targetEnemy, {
    ...
    onend(target) {
      ...
      let damageDefender = calculateAttackDamage(
        targetType == "player",
        attacker,
        defender,
      );
      ...
      if (targetType == "player") {
        if (gameState[11][enemyId] > damageDefender) {
          ...
          gameState[11][enemyId] =
            damageDefender -
            m.floor(damageDefender / units[enemyId][7]) * units[enemyId][7];
        }
      } else {
        if (gameState[13][playerId] > damageDefender) {
          ...
          gameState[12][playerId] -= m.floor(
            damageDefender / units[playerId][7],
          );
          gameState[12][playerId] = m.max(0, gameState[12][playerId]);
          gameState[13][playerId] =
            damageDefender -
            m.floor(damageDefender / units[playerId][7]) * units[playerId][7];
        }
      }

      let damageAttacker = calculateAttackDamage(
        targetType == "enemy",
        defender,
        attacker,
      );
      ...
      if (targetType == "enemy") {
        if (gameState[11][enemyId] > damageAttacker) {
          ...
          gameState[11][enemyId] =
            damageAttacker -
            m.floor(damageAttacker / units[enemyId][7]) * units[enemyId][7];
        }
      } else {
        if (gameState[13][playerId] > damageAttacker) {
          ...
          gameState[12][playerId] -= 1;
          gameState[12][playerId] -= m.floor(
            damageAttacker / units[playerId][7],
          );
          gameState[12][playerId] = m.max(0, gameState[12][playerId]);
          gameState[13][playerId] =
            damageAttacker -
            m.floor(damageAttacker / units[playerId][7]) * units[playerId][7];
        }
      }

      targetPlayerAmount.innerHTML = formatNumber(
        gameState[12][playerId],
        true,
      );
      ...
      if (targetType == "player") {
        ...
        playerUnitCountDifference =
          gameState[12][playerId] - oldPlayerUnitCount;
      ...
      if (enemyUnitCountDifference < 0) {
        insertHtml(
          targetEnemy,
          "beforebegin",
          `<span id="e-${currentTime}" class="damage-indicator">${formatNumber(
            enemyUnitCountDifference,
            true,
          )}</span>`,
        );
      ...
      if (playerUnitCountDifference < 0) {
        insertHtml(
          targetPlayer,
          "afterend",
          `<span id="p-${currentTime}" class="damage-indicator">${formatNumber(
            playerUnitCountDifference,
            true,
          )}</span>`,
        );
...
const setup = () => {
  ...
  insertHtml(
    getElemById("normalIcon"),
    afterbegin,
    uiIcons.level.replace("<path ", '<path fill="#4d85b9" '),
  );
  ...
  if (gameState[34]) {
    ...
    insertHtml(
      getElemById("navSkills"),
      afterbegin,
      `<strong>${premiumIcons.book}</strong>`,
    );
    insertHtml(
      getElemById("navBattle"),
      afterbegin,
      `<strong>${premiumIcons.battle}</strong>`,
    );
    insertHtml(
      getElemById("navMorality"),
      afterbegin,
      `<strong>${premiumIcons.morality}</strong>`,
    );
    insertHtml(
      getElemById("navTrophies"),
      afterbegin,
      `<strong>${premiumIcons.trophy}</strong>`,
    );
  } else {
    insertHtml(
      getElemById("goldBlock"),
      afterbegin,
      uiIcons.gold.replace("<path ", '<path fill="#c7aa0a" '),
    );
    insertHtml(
      getElemById("playerLevelBlock"),
      afterbegin,
      uiIcons.level.replace("<path ", '<path fill="#4d85b9" '),
    );
  ...
  addEvent(getElemById("attackAttribute"), click, () => {
    // eslint-disable-line no-undef
    addAttribute(0);
  });
  addEvent(getElemById("defenseAttribute"), click, () => {
    // eslint-disable-line no-undef
    addAttribute(1);
  });
  ...
  addEvent(skillLockElement, click, (e) => {
    // eslint-disable-line no-undef
  ...
  addEvent(attackElement, click, () => {
    // eslint-disable-line no-undef
    attack(attackElement);
  });

  addEvent(getElemById("popupButton"), click, () => {
    // eslint-disable-line no-undef
    closePopUp();
  });
  ...
  for (let i = 0; i < getLength(navElements); i++) {
    addEvent(navElements[i], click, (e) => {
      // eslint-disable-line no-undef
  ...
  for (let i = 0; i < getLength(buyAmountElements); i++) {
    addEvent(buyAmountElements[i], click, (e) => {
      // eslint-disable-line no-undef
      e.preventDefault();
  ...
  addEvent(getElemById("premiumSwitch"), click, (e) => {
    // eslint-disable-line no-undef
    switchTheme(true, e);
  });

  addEvent(getElemById("e"), click, () => {
    // eslint-disable-line no-undef
    restartGame();
  });
